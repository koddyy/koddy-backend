...
include::{snippets}/CoffeeChatApi/Schedule/Mentor/Success/http-request.adoc[]
include::{snippets}/CoffeeChatApi/Schedule/Mentor/Success/query-parameters.adoc[]

*HTTP Response*

include::{snippets}/CoffeeChatApi/Schedule/Mentor/Success/http-response.adoc[]
include::{snippets}/CoffeeChatApi/Schedule/Mentor/Success/response-fields.adoc[]

=== 멘티

*HTTP Request*

include::{snippets}/CoffeeChatApi/Schedule/Mentee/Success/http-request.adoc[]
include::{snippets}/CoffeeChatApi/Schedule/Mentee/Success/query-parameters.adoc[]

*HTTP Response*

include::{snippets}/CoffeeChatApi/Schedule/Mentee/Success/http-response.adoc[]
include::{snippets}/CoffeeChatApi/Schedule/Mentee/Success/response-fields.adoc[]
