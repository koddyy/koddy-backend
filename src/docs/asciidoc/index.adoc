...
=== 멘토 마이페이지 프로필 조회 (OnlyMentor)

==== HTTP Request

include::{snippets}/MemberApi/PrivateProfile/Mentor/Success/http-request.adoc[]

==== HTTP Response

include::{snippets}/MemberApi/PrivateProfile/Mentor/Success/http-response.adoc[]
include::{snippets}/MemberApi/PrivateProfile/Mentor/Success/response-fields.adoc[]

=== 멘티 마이페이지 프로필 조회 (OnlyMentee)

==== HTTP Request

include::{snippets}/MemberApi/PrivateProfile/Mentee/Success/http-request.adoc[]

==== HTTP Response

include::{snippets}/MemberApi/PrivateProfile/Mentee/Success/http-response.adoc[]
include::{snippets}/MemberApi/PrivateProfile/Mentee/Success/response-fields.adoc[]
