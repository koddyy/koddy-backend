...
public enum CoffeeChatExceptionCode implements KoddyExceptionCode {
    ...
    PENDING_COFFEE_CHAT_NOT_FOUND(NOT_FOUND, "COFFEE_CHAT_006", "최종 결정 대기 목록에 존재하지 않는 커피챗입니다."),
    APPLIED_OR_SUGGESTED_COFFEE_CHAT_NOT_FOUND(NOT_FOUND, "COFFEE_CHAT_007", "신청/제안 상태인 커피챗이 존재하지 않습니다."),
