...
public enum CoffeeChatExceptionCode implements KoddyExceptionCode {
    ...
    APPLIED_OR_SUGGESTED_COFFEE_CHAT_NOT_FOUND(NOT_FOUND, "COFFEE_CHAT_006", "신청/제안 상태인 커피챗이 존재하지 않습니다."),
    CANNOT_CANCEL_STATUS(CONFLICT, "COFFEE_CHAT_007", "취소할 수 없는 상태입니다."),
    CANNOT_APPROVE_STATUS(CONFLICT, "COFFEE_CHAT_008", "수락할 수 없는 상태입니다."),
    CANNOT_REJECT_STATUS(CONFLICT, "COFFEE_CHAT_009", "거절할 수 없는 상태입니다."),
