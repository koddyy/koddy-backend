...
public class MenteeMainSearchUseCase {
    ...
    public List<MentorSimpleSearchProfile> getSuggestedMentors(final long menteeId) {
        final List<Mentor> result = menteeMainSearchRepository.fetchSuggestedMentors(menteeId, 3);
