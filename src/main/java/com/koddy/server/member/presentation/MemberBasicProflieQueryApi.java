...
public class MemberBasicProflieQueryApi {
    ...
    public MemberBasicProflieQueryApi(final GetMemberBasicProfileUseCase getMemberBasicProfileUseCase) {
        this.getMemberBasicProfileUseCase = getMemberBasicProfileUseCase;
    }
