...
public enum MemberExceptionCode implements KoddyExceptionCode {
    ...
    INVALID_LANGUAGE_CATEGORY(BAD_REQUEST, "MEMBER_009", "유효하지 않은 언어 종류입니다."),
    INVALID_LANGUAGE_TYPE(BAD_REQUEST, "MEMBER_010", "유효하지 않은 언어 레벨입니다."),
    INVALID_DAY(BAD_REQUEST, "MEMBER_011", "유효하지 않은 날짜입니다."),
    ;
