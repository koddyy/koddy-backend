    ...
    class GetMentorsByCondition {
        ...
        void success() {
            ...
            final String url3 = UriComponentsBuilder
                    .fromUriString("/api/mentors?page=1&languages=EN")
                    .build()
                    .toUriString();
            ...
            final String url4 = UriComponentsBuilder
                    .fromUriString("/api/mentors?page=2&languages=EN")
                    .build()
                    .toUriString();
            ...
            final String url5 = UriComponentsBuilder
                    .fromUriString("/api/mentors?page=1&languages=JP&languages=CN")
                    .build()
                    .toUriString();
            ...
            final String url6 = UriComponentsBuilder
                    .fromUriString("/api/mentors?page=2&languages=JP&languages=CN")
                    .build()
                    .toUriString();
