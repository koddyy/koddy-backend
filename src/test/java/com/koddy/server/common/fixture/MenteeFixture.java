...
public enum MenteeFixture {
    MENTEE_1(
            new SocialPlatform(GOOGLE, "ID-MENTEE-1", new Email("mentee1@gmail.com")),
            "멘티1", "s3/Mentee1.png", USA, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("경기대학교", "컴퓨터공학부")
    ),
    MENTEE_2(
            new SocialPlatform(GOOGLE, "ID-MENTEE-2", new Email("mentee2@gmail.com")),
            "멘티2", "s3/Mentee2.png", CHINA, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("서울대학교", "컴퓨터공학부")
    ),
    MENTEE_3(
            new SocialPlatform(GOOGLE, "ID-MENTEE-3", new Email("mentee3@gmail.com")),
            "멘티3", "s3/Mentee3.png", JAPAN, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("연세대학교", "컴퓨터공학부")
    ),
    MENTEE_4(
            new SocialPlatform(GOOGLE, "ID-MENTEE-4", new Email("mentee4@gmail.com")),
            "멘티4", "s3/Mentee4.png", VIETNAM, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("고려대학교", "컴퓨터공학부")
    ),
    MENTEE_5(
            new SocialPlatform(GOOGLE, "ID-MENTEE-5", new Email("mentee5@gmail.com")),
            "멘티5", "s3/Mentee5.png", ETC, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("한양대학교", "컴퓨터공학부")
    ),
    MENTEE_6(
            new SocialPlatform(GOOGLE, "ID-MENTEE-6", new Email("mentee6@gmail.com")),
            "멘티6", "s3/Mentee6.png", USA, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("경기대학교", "컴퓨터공학부")
    ),
    MENTEE_7(
            new SocialPlatform(GOOGLE, "ID-MENTEE-7", new Email("mentee7@gmail.com")),
            "멘티7", "s3/Mentee7.png", CHINA, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("서울대학교", "컴퓨터공학부")
    ),
    MENTEE_8(
            new SocialPlatform(GOOGLE, "ID-MENTEE-8", new Email("mentee8@gmail.com")),
            "멘티8", "s3/Mentee8.png", JAPAN, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("연세대학교", "컴퓨터공학부")
    ),
    MENTEE_9(
            new SocialPlatform(GOOGLE, "ID-MENTEE-9", new Email("mentee9@gmail.com")),
            "멘티9", "s3/Mentee9.png", VIETNAM, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("고려대학교", "컴퓨터공학부")
    ),
    MENTEE_10(
            new SocialPlatform(GOOGLE, "ID-MENTEE-10", new Email("mentee10@gmail.com")),
            "멘티10", "s3/Mentee10.png", ETC, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("한양대학교", "컴퓨터공학부")
    ),
    MENTEE_11(
            new SocialPlatform(GOOGLE, "ID-MENTEE-11", new Email("mentee11@gmail.com")),
            "멘티11", "s3/Mentee11.png", USA, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("경기대학교", "컴퓨터공학부")
    ),
    MENTEE_12(
            new SocialPlatform(GOOGLE, "ID-MENTEE-12", new Email("mentee12@gmail.com")),
            "멘티12", "s3/Mentee12.png", CHINA, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("서울대학교", "컴퓨터공학부")
    ),
    MENTEE_13(
            new SocialPlatform(GOOGLE, "ID-MENTEE-13", new Email("mentee13@gmail.com")),
            "멘티13", "s3/Mentee13.png", JAPAN, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("연세대학교", "컴퓨터공학부")
    ),
    MENTEE_14(
            new SocialPlatform(GOOGLE, "ID-MENTEE-14", new Email("mentee14@gmail.com")),
            "멘티14", "s3/Mentee14.png", VIETNAM, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("고려대학교", "컴퓨터공학부")
    ),
    MENTEE_15(
            new SocialPlatform(GOOGLE, "ID-MENTEE-15", new Email("mentee15@gmail.com")),
            "멘티15", "s3/Mentee15.png", ETC, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("한양대학교", "컴퓨터공학부")
    ),
    MENTEE_16(
            new SocialPlatform(GOOGLE, "ID-MENTEE-16", new Email("mentee16@gmail.com")),
            "멘티16", "s3/Mentee16.png", USA, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("경기대학교", "컴퓨터공학부")
    ),
    MENTEE_17(
            new SocialPlatform(GOOGLE, "ID-MENTEE-17", new Email("mentee17@gmail.com")),
            "멘티17", "s3/Mentee17.png", CHINA, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("서울대학교", "컴퓨터공학부")
    ),
    MENTEE_18(
            new SocialPlatform(GOOGLE, "ID-MENTEE-18", new Email("mentee18@gmail.com")),
            "멘티18", "s3/Mentee18.png", JAPAN, "Hello World~",
            LanguageFixture.메인_영어_서브_일본어(), new Interest("연세대학교", "컴퓨터공학부")
    ),
    MENTEE_19(
            new SocialPlatform(GOOGLE, "ID-MENTEE-19", new Email("mentee19@gmail.com")),
            "멘티19", "s3/Mentee19.png", VIETNAM, "Hello World~",
            LanguageFixture.메인_영어_서브_한국어(), new Interest("고려대학교", "컴퓨터공학부")
    ),
    MENTEE_20(
            new SocialPlatform(GOOGLE, "ID-MENTEE-20", new Email("mentee20@gmail.com")),
