...
//                    MENTOR_1.platform.getProvider().getValue(),
//                    MENTOR_1.platform.getSocialId(),
//                    MENTOR_1.platform.getEmail().getValue(),
//                    MENTOR_1.getName(),
...
//                            )
//                    ),
//                    MENTOR_1.universityProfile.getSchool(),
//                    MENTOR_1.universityProfile.getMajor(),
//                    MENTOR_1.universityProfile.getEnteredIn()
//            );
//
//            // when - then
//            successfulExecute(
...
//                    MENTEE_1.platform.getProvider().getValue(),
//                    MENTEE_1.platform.getSocialId(),
//                    MENTEE_1.platform.getEmail().getValue(),
//                    MENTEE_1.getName(),
//                    MENTEE_1.nationality.code,
//                    new LanguageRequestModel(Language.Category.KR.code, List.of()),
//                    MENTEE_1.interest.getSchool(),
//                    MENTEE_1.interest.getMajor()
//            );
//
//            // when - then
//            successfulExecute(
