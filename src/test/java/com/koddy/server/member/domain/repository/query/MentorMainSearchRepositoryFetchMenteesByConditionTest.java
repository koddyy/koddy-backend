...
class MentorMainSearchRepositoryFetchMenteesByConditionTest extends RepositoryTest {
    ...
    void withLanguage() {
        // given
        final SearchMenteeCondition condition1 = SearchMenteeCondition.of(List.of(), List.of(KR));
        final SearchMenteeCondition condition2 = SearchMenteeCondition.of(List.of(), List.of(JP));
        final SearchMenteeCondition condition3 = SearchMenteeCondition.of(List.of(), List.of(EN, KR));
    ...
    void withNationalityAndLanguage() {
        // given
        final SearchMenteeCondition condition1 = SearchMenteeCondition.of(List.of(USA, CHINA, JAPAN), List.of(KR));
        final SearchMenteeCondition condition2 = SearchMenteeCondition.of(List.of(USA, CHINA, JAPAN), List.of(JP));
        ...
        assertAll(
                () -> assertThat(result1.hasNext()).isFalse(),
                () -> assertThat(result1.getContent()).containsExactly(mentees[16], mentees[12], mentees[10], mentees[6], mentees[2], mentees[0]),
                () -> assertThat(result2.hasNext()).isFalse(),
                () -> assertThat(result2.getContent()).containsExactly(mentees[17], mentees[15], mentees[11], mentees[7], mentees[5], mentees[1])
        );

        /* 페이지 2 */
        final Slice<Mentee> result3 = sut.fetchMenteesByCondition(condition1, pageable2);
        final Slice<Mentee> result4 = sut.fetchMenteesByCondition(condition2, pageable2);
